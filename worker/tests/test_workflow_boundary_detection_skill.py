...
def load_evidence_segmentation_module():
    ...
    sys.modules["worker.ai_skills.semantic_enrichment.schemas"] = load_semantic_schemas_module()
    sys.modules["worker.ai_skills.semantic_enrichment.skill"] = load_semantic_skill_module()
    sys.modules["worker.ai_skills.workflow_boundary_detection.schemas"] = load_schemas_module()
    sys.modules["worker.ai_skills.workflow_boundary_detection.skill"] = load_skill_module()
