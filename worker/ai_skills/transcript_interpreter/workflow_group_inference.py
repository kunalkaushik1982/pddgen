...
from worker.ai_skills.transcript_interpreter.models import ProcessGroupInterpretation
from worker.ai_skills.transcript_interpreter.workflow_prompts import PROCESS_GROUP_INFERENCE_PROMPT
