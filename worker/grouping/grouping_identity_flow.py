...
from worker.ai_skills.transcript_interpreter.interpreter import WorkflowGroupMatchInterpretation, WorkflowTitleInterpretation
...
# ISP fix: narrow Protocol that describes only what the free functions below
# actually require from the grouping service. Replaces the previous `Any` type.
...
def resolve_group_identity(
    service: GroupingServiceProtocol,
    *,
