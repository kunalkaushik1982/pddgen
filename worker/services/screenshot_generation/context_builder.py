...
from worker.services.screenshot_generation.context_cleanup import reset_screenshot_state, strip_screenshot_evidence
from worker.services.screenshot_generation.context_resolution import (
