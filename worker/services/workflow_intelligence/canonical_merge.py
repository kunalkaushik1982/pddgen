...
class CanonicalProcessMergeService:
    ...
    def _merge_steps(self, canonical_steps: list[StepRecord], transcript_steps: list[StepRecord]) -> list[StepRecord]:
    ...
    def _merge_notes(self, canonical_notes: list[NoteRecord], transcript_notes: list[NoteRecord]) -> list[NoteRecord]:
    ...
    def _match_step_indexes(self, canonical_steps: list[StepRecord], transcript_steps: list[StepRecord]) -> dict[int, int]:
    ...
    def _step_similarity(self, left: StepRecord, right: StepRecord) -> float:
    ...
    @staticmethod
    def _step_transcript_id(step: StepRecord) -> str | None:
    ...
    @staticmethod
    def _note_transcript_id(note: NoteRecord) -> str | None:
