...
from worker.services.ai_transcript.diagram_interpreter import interpret_diagrams as ai_interpret_diagrams
...
from worker.services.ai_transcript.transcript_adaptation import build_legacy_transcript_interpretation
